...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-roam dap-mode doom-modeline company csharp-mode js2-mode magit spinner flycheck-rust racer rust-mode lisp-mode elisp-slime-nav paredit counsel slime py-autopep8 elpy lsp-ui lsp-javascript-flow lsp-javascript-typescript lsp-python cquery lsp-clangd spacemacs-theme rainbow-mode rainbow-delimiters use-package ivy yasnippet-snippets neotree flycheck)))
(custom-set-faces
